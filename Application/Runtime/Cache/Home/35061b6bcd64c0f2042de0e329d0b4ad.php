...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="widget blue">
            <div class="widget-title">
                <h4><i class="icon-reorder"></i> 添加临时订单</h4>
                <span class="tools">
            ...
            <div class="widget-body">
                <!-- BEGIN FORM-->
                <div class="row-fluid">
                    <form action="<?php echo U('order/tempadd');?>" class="form-horizontal" method="post">
                        <div class="control-group">
                            <label class="control-label">临时订单</label>
                            <div class="controls">
                                <textarea class="input-xxlarge" rows="6" name="content"></textarea>
                            </div>
                        </div>
  ...
  <div class="row-fluid">
        <div class="span12">
            ...
            <div class="widget blue">
                <div class="widget-title">
                    <h4><i class="icon-reorder"></i> 临时订单列表</h4>
                <span class="tools">
                    <a href="javascript:;" class="icon-chevron-down"></a>                   
                </span>
                </div>
                <div class="widget-body">
                    <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                            ...
                            <td class="span12"><?php echo ($vo["content"]); ?></td>
                            <td><?php echo (date("Y-m-d H:i:s",$vo["ctime"])); ?></td>
                            <td>
                                <a href="<?php echo U('order/tempdel',array('id'=>$vo['id']));?>">
